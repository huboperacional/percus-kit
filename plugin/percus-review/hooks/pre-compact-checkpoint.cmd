...
set "PERCUS_HOOK_PS1=%~dp0pre-compact-checkpoint.ps1"
if not defined PERCUS_CANON_DIR goto :percus_roda
if not exist "%PERCUS_CANON_DIR%\plugin\percus-review\hooks\pre-compact-checkpoint.ps1" goto :percus_roda
set "PERCUS_HOOK_PS1=%PERCUS_CANON_DIR%\plugin\percus-review\hooks\pre-compact-checkpoint.ps1"
:percus_roda
